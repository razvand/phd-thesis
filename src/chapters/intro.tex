...
service. Peer-to-Peer have reemerged in late 90s when Napster\footnote{TODO}
...
Internet\footnote{TODO}, the BitTorrent protocol\cite{TODO} has captured the
attention of research and commercial entities alike. With a
``tit-for-tat''\footnote{TODO} algorithm at its base, the BitTorrent protocol
...
P2P-Next Project\footnote{TODO}, extensive focus has been given to using P2P
...
protocols such as swift\cite{TODO} are proof to the continuous birth of new
...
The PlanetLab\footnote{http://www.planetlab.org} infrastructure provides a
...
conducting experiments and data collection. \todo{cite paper using Planet Lab}
...
on top of a much lower number of systems (by the order of tens)\cite{TODO}.
...
implementation\footnote{TODO} is an important component, highlighting the
...
technology\footnote{TODO}, an advanced Peer-to-Peer implementation based on
BitTorrent.
