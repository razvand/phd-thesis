...
\subsection{Mesajele protocolului}
...
Datele și parametrii care au fost măsurati sunt cei specifici clienților și
...
\subsection{Abordări pentru colectarea și extragerea parametrilor protocolului}
