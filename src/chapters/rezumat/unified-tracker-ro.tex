...
mesh. Two networks are connected with the aid of \textbf{border trackers}.
...
\textit{external network}. A tracker which has both
...
seeders and leechers for each scenario is shown.
