...
sought out solutions for integrating streaming support. Either through
video-on-demand (VoD) or live streaming, various P2P streaming solutions have
emerged~\cite{p2p-streaming-survey}, claiming scalability and reduced cost.
Classical and main content distribution solutions are Content Delivery
Networks (CDN) such as Akamai\footnote{http://www.akamai.com/}.
...
libtorrent-rasterbar. We have added two streaming algorithms that
