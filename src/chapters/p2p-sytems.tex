...
client-server, the emergence of Napster\footnote{TODO} has pushed Peer-to-Peer
...
shared\footnote{TODO}, Napster became the center of public attention and the
...
The Pirate Bay\footnote{TODO} have highlighted the troubled environment in
...
if SETI@home\footnote{TODO}. SETI@home is a scientific initiative launched by
...
FastTrack\footnote{TODO}. Another example of such a topology is the e-mail
...
Napster\footnote{TODO} was the first successful example of a Peer-to-Peer
...
Initially, Gnutella\footnote{TODO} was the name of a prototype client developed in just a few
...
The Gnutella protocol is highly correlated with the HTTP protocol. All nodes
...
architectures is the FastTrack network\footnote{TODO}. FastTrack arrived as a solution to
...
Some clients (like Kazaa\footnote{TODO}) use a method named reputation system. Reputation is
...
The eDonkey network\footnote{TODO} is a centralized P2P file sharing system. Several central
...
As a result, Overnet\footnote{TODO} was developed by MetaMachine, the initial developer of
eDonkey client, and Kademlia\footnote{TODO} was developed by eMule project.
...
DirectConnect\footnote{TODO} is a centralized protocol for P2P file sharing. Its architecture
...
JXTA project\footnote{TODO} (short for \textit{juxtaposition}), or
...
Trust" used by PGP\footnote{TODO} to secure e-mail messages and is used for transferring public keys
...
JXTA applications allow interactive access to the P2P JXTA platform. Many of them
...
BitTorrent\footnote{TODO} is a new protocol being used to solve the free riding problem,
...
employed by YouTube\footnote{TODO}.
