...
\todo{message types, measured parameters}
\todo{approaches to data collection}
\todo{generic logging library}
\todo{processing framework}
\todo{rendering engine}
\todo{evaluation from parameters}
