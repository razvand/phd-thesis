...
performance, user satisfaction and functionality. Such analysis is generally
...
process receives this signal, it is immediately stopped and all its opened
...
bandwidth peers.  At around 13:05, the high bandwidth clients have finished
...
OpenVZ was chooses as the virtualization solution. A lightweight operating
...
various processes. Due to its low memory foot print it was fairly easy to
...
withing a given OpenVZ container and be part of the simulated swarm.
