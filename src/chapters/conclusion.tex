...
\begin{itemize}
  ...
  Traffic Engineering Solution in GMPLS Grid Networks, 17th International
  Conference on Control Systems and Computer Science - CSCS17, Bucharest, 2009
  \item Răzvan Rughiniș and Răzvan Deaconescu, Optimization Strategies in MPLS
  Traffic Engineering, UPB Scientific Bulletin, Series C, 1/ 2009, ISSN
  1454-234x, pp. 91-102
  \item Răzvan Rughiniș and Răzvan Deaconescu, Methods of Adjusting MPLS
  Network Policies, UPB Scientific Bulletin, Series C, 3/ 2009, ISSN
  1454-234x, pp. 121-132
  \item Mircea Bardac, Răzvan Deaconescu and Adina Magda Florea, Scaling
  Peer-to-Peer testing using Linux Containers, 9th RoEduNet IEEE International
  Conference 2010, June 24-26, 2010, Sibiu, Romania, pag. 287-292, ISSN:
  2068-1038, ISBN 978-1-4244-7335-9
  ...
  Networks, The Fifth International Conference on Systems and Networks
  Communications, 2010
  \item Laura Gheorghe, Răzvan Rughiniș, Răzvan Deaconescu and Nicolae Țăpuș,
  Reliable Authentication and Anti-replay Security Protocol for Wireless
  Sensor Networks, The Second International Conferences on Advanced Service
  Computing, 2010
